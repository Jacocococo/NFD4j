...
jar -c -f ../dist/NativeFileDialog.jar -C ../dist com/jacoco/nfd/NativeFileDialog.class
...
gcc -shared -o ../dist/libnfd4j.so ../dist/com/jacoco/nfd/com_jacoco_nfd_NativeFileDialog.o ../../build/lib/Release/${arch}/* `pkg-config --libs gtk+-3.0`
